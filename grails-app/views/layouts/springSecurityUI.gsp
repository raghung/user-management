	...
	<div>
		...
		<div>
			...
			<ul class="jd_menu jd_menu_slate">
				<sec:access controller='user' action='search'>
				...
				<sec:access controller='role' action='search'>
				...
				<sec:access controller='requestmap' action='search'>
				...
				<sec:access controller='persistentLogin' action='search'>
